...
getContentPane().setBackground(Color.gray);
        l=new JLabel();
   o= new JLabel("HEY USER ITS TIME TO TEST YOUR KNOWLEDGE");
o.setBounds(200,10,450,20); 
b3 = new JButton("1. made by  PRAKHAR MISHRA   ");
b3.setBounds(500,1,250,100); 
...
add(b3);
        ...
        jb[4].setBounds(500,1,280,100);  
jb[4].setText(" SPECIAL THANK-- RAVI  SIR");
    ...
    {  
        ...
        new OnlineTest("                                                                                                KAUN BANEGA PROGRAMMER");  
    }  
}  